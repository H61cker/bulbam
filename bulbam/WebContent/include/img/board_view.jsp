...
<body>
	...
	<aritcle id="board_area">
	    ...
	    <div class="pull-right">
	        ...
	        <a href="modify.jsp?id=<%= board.getBoardId() %>" class="btn btn-primary btn-warning">수정</a>
	        <a href="delete.jsp?id=<%= board.getBoardId() %>" class="btn btn-primary btn-danger">삭제</a>
	    </div>
	    <br>
	</aritcle>
</body>
