...
<div><input name=title style="width:300px; height:20px; font-size:18px;font-family:함초롬돋움;margin:0 10px; padding:2px 10px" value=""></div>
<br>
<div style="margin:0px 10px;font-size:25px;font-family:함초롬돋움">내용</div>
<div><textarea name=content style="width:700px; height:400px;font-size:18px;font-family:함초롬돋움;margin:0 10px; padding:10px"></textarea></div>
<br>
